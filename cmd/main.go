...
import (
	...
	"github.com/lyracampos/go-grpc/internal"
	greeting_v1 "github.com/lyracampos/go-grpc/pkg/pb/greeting/v1"
	"go.uber.org/zap"
...
func main() {
	...
	greeting_v1.RegisterGreeterServiceServer(server, &internal.GreeterService{})
